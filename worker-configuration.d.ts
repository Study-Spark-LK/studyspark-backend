/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eca332d99cd785fac6a06ae8d2f6d6ed)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ENVIRONMENT: string;
		MAXIMUM_PROFILES_PER_USER: string;
		CLERK_WEBHOOK_SIGNING_KEY: string;
		R2_FILES: R2Bucket;
		DB: D1Database;
		QUEUE_UPSTREAM_INGEST: Queue;
		QUEUE_UPSTREAM_OUTPUT: Queue;
		CF_VERSION_METADATA: WorkerVersionMetadata;
		WORKFLOWS_CLERK_USER_CREATED: Workflow<Parameters<import("./src/main").ClerkUserCreatedWorkflow['run']>[0]['payload']>;
		WORKFLOWS_CLERK_USER_DELETED: Workflow<Parameters<import("./src/main").ClerkUserDeletedWorkflow['run']>[0]['payload']>;
	}
}
